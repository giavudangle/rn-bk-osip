...
class Post extends React.Component {
  ...
  // gotoPostDetail = () => {
  //   AppNavigation.pushScreen.PostDetails(
  //     this.props.parentScreenId,
  //     this.props.data._id
  //   );
  // };
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={[styles.backgroundImage, { aspectRatio: height }]}>
          <TouchableOpacity onPress={this.gotoPostDetail} activeOpacity={1}>
          ...
          <View style={styles.postInfo}>
            ...
            <TouchableOpacity
              activeOpacity={1}
              // onPress={() => this.gotoPeopleInLocation(data)}
        ...
        <View style={{ flexDirection: "row" }}>
          <FormProfilePicture
            ...
            onPress={() => this.gotoGuestPage(data)}
          />
